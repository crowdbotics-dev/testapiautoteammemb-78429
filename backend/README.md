...
## Project Structure
    ...
    ├── testapiautoteammemb_78429  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_78429`
...
2. Clone this repo and `cd testapiautoteammemb_78429`
